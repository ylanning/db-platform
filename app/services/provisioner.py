...
class ProvisionerService:
    ...
    async def run_provision(self, req: ProvisionRequest) -> ProvisionResponse:
        ...
        with log_request_info(db_name=db_name, user_name=user_name, operation="run_provision"):
    ...
    async def run_deprovision(self, req: ProvisionRequest) -> ProvisionResponse:
        ...
        with log_request_info(db_name=db_name, user_name=user_name, operation="run_deprovision"):
            try:
    ...
    async def run_status(self, db_id: str) -> StatusResponse:
    ...
    async def run_rotate_credentials(
        ...
        with log_request_info(
            db_name=req.db_id, user_name=user_name, operation="run_rotate_credentials"
        ):
            try:
