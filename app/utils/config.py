...
class DatabaseSettings(BaseSettings):
    ...
    backup_bucket: str = field(None, description="GCS bucket name for storing database backups")
    secret_prefix: str = field("dbs", description="Prefix for secrets storing database credentials")
